...
public class FavoritesFragments extends Fragment implements OnSearchListener{
    ...
    private List<Contact> myFavContacts;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myFavContacts = dbHelper.getContacts(AppConstants.TABLE_CONTACTS, AppConstants.QUERY_GET_FAVORITE_CONTACTS);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewAdapter (myFavContacts, mActivity);
        recyclerView.setAdapter(mAdapter);
        implementsRecyclerViewOnItemClickListener();

        stickyIndex.setDataSet(getIndexList(myFavContacts));
