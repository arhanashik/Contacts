...
import com.example.user.contacts.adapters.StickyIndexAdapter;
import com.example.user.contacts.layout.IndexLayoutManager;
import com.example.user.contacts.listeners.IndexScrollListener;
import com.example.user.contacts.listeners.Subscriber;
...
public class StickyIndex extends RelativeLayout {
    ...
    private StickyIndexAdapter adapter;
    ...
    private void initialize (Context context, AttributeSet attrs) {
        ...
        StickyIndexAdapter.RowStyle styles = getRowStyle(context, attrs);
        ...
        this.adapter = new StickyIndexAdapter(dataSet, styles);
    ...
    private StickyIndexAdapter.RowStyle getRowStyle (Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            return new StickyIndexAdapter.RowStyle(
    ...
    private void setStickyIndexStyle (StickyIndexAdapter.RowStyle styles) {
